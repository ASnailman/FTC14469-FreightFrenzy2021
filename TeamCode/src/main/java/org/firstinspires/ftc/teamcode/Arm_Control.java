...
public class Arm_Control {
    ...
    double pos_arm_power_limit;
    double neg_arm_power_limit;
    ...
    public void SetTargetPosition(double target, double negpower, double pospower) {
        ...
        pos_arm_power_limit = pospower;
        neg_arm_power_limit = negpower;
    ...
    public void ArmTask () {
        ...
        if (run_state == Task_State.RUN || run_state == Task_State.DONE || run_state == Task_State.READY) {
            ...
            clipped_cmd = Range.clip(cmd, -neg_arm_power_limit, pos_arm_power_limit);
