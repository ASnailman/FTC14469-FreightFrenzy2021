...
public class hk_Arm_Control {
    ...
    // CONSTRUCTOR
    public hk_Arm_Control(DcMotor motor) {
    ...
    public void ArmTask () {
        ...
        if (run_state == Task_State.RUN || run_state == Task_State.DONE || run_state == Task_State.READY) {
            ...
            clipped_cmd = Range.clip(cmd, -0.6, arm_power_limit);
