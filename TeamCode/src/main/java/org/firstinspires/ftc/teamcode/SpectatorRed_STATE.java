            ...
            switch (programorder1) {
                ...
                case 3:
                    if (MechDrive.GetTaskState() == Task_State.INIT || MechDrive.GetTaskState() == Task_State.READY ||
                        ...
                        if (left) {
                            MechDrive.SetTargets(135, 2000, 0.35, 0);
                        }
                        else if (center) {
                            MechDrive.SetTargets(135, 1550, 0.35, 0); // 1600
                        }
                        else {
                            MechDrive.SetTargets(135, 1800, 0.35, 0); // 1600
                        }
                ...
                case 5:
                    if (ET.milliseconds() > 500) { // Prev: 1000
                        ...
                        if (left) {
                            MechDrive.SetTargets(-45, 2000, 0.7, 0); // 2100
                        } else if (center) {
                            MechDrive.SetTargets(-45, 1550, 0.7, 0); // 1750
                        } else {
                            MechDrive.SetTargets(-45, 1800, 0.7, 0); // 2000
                        }
                ...
                case 22:
                    if (MechDrive.GetTaskState() == Task_State.READY) {
                        MechDrive.SetTargets(80, 1150, 0.5, 0);
                    }
