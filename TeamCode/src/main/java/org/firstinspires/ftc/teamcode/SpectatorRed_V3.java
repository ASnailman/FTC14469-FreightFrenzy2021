                ...
                case 4:
                    if (left) {
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Low_Arm_Right, -0.6, 0.6, 0.04);
                        }
                        ...
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Middle_Arm_Right, -0.6, 0.6, 0.04);
                        }
                        else if (ArmControl.GetTaskState() == Task_State.DONE) {
                            programorder1++;
                        }
                        ...
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Top_Arm_Right, -0.6, 0.6, 0.04);
                        }
                        else if (ArmControl.GetTaskState() == Task_State.DONE) {
                            programorder1++;
                        }
