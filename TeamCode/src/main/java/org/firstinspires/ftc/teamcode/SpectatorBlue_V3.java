                ...
                case 4:
                    if (left) {
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Low_Arm_Left, -0.6, 0.6, 0.08);
                        }
                        ...
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Middle_Arm_Left, -0.6, 0.6, 0.08);
                        }
                        else if (ArmControl.GetTaskState() == Task_State.DONE) {
                            programorder1++;
                        }
                        ...
                        if (ArmControl.GetTaskState() == Task_State.INIT) {
                            ArmControl.SetTargetPosition(Top_Arm_Left, -0.6, 0.6, 0.08);
                        }
                        else if (ArmControl.GetTaskState() == Task_State.DONE) {
                            programorder1++;
                        }
                ...
                case 8:
                    if (left) {
                        if (ArmControl.GetTaskState() == Task_State.READY) {
                            ArmControl.SetTargetPosition(0, -0.7, -0.7, 0.04);
                        }
                        else if (ArmControl.GetTaskState() == Task_State.DONE) {
                            programorder1++;
                        }
