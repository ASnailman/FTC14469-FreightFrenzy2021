...
@TeleOp(name="StateTeleopAllianceBlue", group="MecanumDrive")
public class StateTeleopAllianceBlue extends LinearOpMode {
    ...
    static final double MiddleBucketPosition = 146;
        ...
        while (opModeIsActive()) {
            ...
            if (BucketIsEmpty) {
                ...
                if (yellow) {
                    ...
                    //if (YELLOW1) {
                        if (ET1.milliseconds() > 500 && Math.abs(FrontRight.getPower()) > 0.01) {
                            Intake.setPower(1);
                        }
                    //}
                    BucketIsEmpty = false;
                    ...
                    //if (white && FrontRight.getPower() > 0.1) {
                        ...
                        CarouselLeft.setPower(1);
                        IntakeServo.setPosition(ClosingIntakePosition);
                        if (ET1.milliseconds() > 200 && Math.abs(FrontRight.getPower()) > 0.01) {
                            Intake.setPower(1);
                        }
                    //}
                    BucketIsEmpty = false;
                ...
                if (ET1.milliseconds() > 300 && Math.abs(FrontRight.getPower()) > 0.01) {
                    Intake.setPower(1);
                }
            ...
            if (button_left_trigger_already_pressed == false) {
                if (gamepad2.left_trigger > 0 && gamepad2.right_trigger == 0) {
                    ...
                    bucketposition = bucketposition + 10;
                    manualcalleft = 1;
            ...
            /*****************************************************************
             * Right Trigger (G1) - Failsafe Recovery
             *****************************************************************/
