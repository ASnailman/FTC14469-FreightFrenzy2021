...
@Autonomous(name="FarBlue_STATEV3", group="MecanumDrive")
public class FarBlue_STATEV3 extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            switch (programorder1) {
                ...
                case 0:
                    ...
                    else if (pipeline.position == FarBlue_STATEV3.BarcodeDeterminationPipeline.ShippingElementPosition.CENTER) {
                        left = false;
                        center = true;
                        right = false;
                    }
                    else if (pipeline.position == FarBlue_STATEV3.BarcodeDeterminationPipeline.ShippingElementPosition.RIGHT) {
                        left = false;
                        center = false;
                        right = true;
                    }
                ...
                case 6:
                    ...
                    if (ET.milliseconds() > 500) { // Prev: 1000
                        if (laps == 1) {
                            ...
                            MechDrive.SetTargets(-65, 1750, 0.9, 0);
                            WallDetector_Enable(0);
                        }
                        else {
                            MechDrive.SetTargets(-65, 1750, 0.9, 0);
