...
public class FarBlue_V3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            switch (programorder1) {
                ...
                case 0:
                    if (pipeline.position == FarBlue_V3.BarcodeDeterminationPipeline.ShippingElementPosition.LEFT) {
                        left = true;
                        center = false;
                        right = false;
                    }
                    else if (pipeline.position == FarBlue_V3.BarcodeDeterminationPipeline.ShippingElementPosition.CENTER) {
                        left = false;
                        center = true;
                        right = false;
                    }
                    else if (pipeline.position == FarBlue_V3.BarcodeDeterminationPipeline.ShippingElementPosition.RIGHT) {
                        left = false;
                        center = false;
                        right = true;
                    }
    ...
    public static class BarcodeDeterminationPipeline extends OpenCvPipeline
    {
         ...
         */
        static final Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(60,180);
        static final Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(500,65);
