    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            switch (programorder1) {
                ...
                case 0:
                    if (pipeline.position == FarRed_V3.BarcodeDeterminationPipeline.ShippingElementPosition.LEFT) {
                        left = true;
                        center = false;
                        right = false;
                    }
                    else if (pipeline.position == FarRed_V3.BarcodeDeterminationPipeline.ShippingElementPosition.CENTER) {
                        left = false;
                        center = true;
                        right = false;
                    }
                    else if (pipeline.position == FarRed_V3.BarcodeDeterminationPipeline.ShippingElementPosition.RIGHT) {
                        left = false;
                        center = false;
                        right = true;
                    }
                ...
                case 15:
                    if (MechDrive.GetTaskState() == Task_State.READY) {
                        if (left) {
                            MechDrive.SetTargets(-90, 1170, 0.42);
                        }
                        else if (center) {
